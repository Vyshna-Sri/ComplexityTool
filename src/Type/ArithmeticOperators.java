...
public class ArithmeticOperators {
	...
	//private int totalNumberOfArithmeticOperators = 0;
	private int i = 0;
	...
	public int[] complexity(String[] code) {
	    ...
	    for (String s : code) {
	        ...
	        //System.out.println("\tNumber Of Arithmetic Operators :"+ numberOfArithmeticOperators);
	        //System.out.println("");
	        complexity[i] = numberOfArithmeticOperators* complexityValue;
	        
	    	
	    	//totalNumberOfArithmeticOperators = totalNumberOfArithmeticOperators + numberOfArithmeticOperators;
	    	numberOfArithmeticOperators = 0;
	    	i++;
	    }
        //System.out.println("Total Number Of Arithmetic Operators :" +totalNumberOfArithmeticOperators);
